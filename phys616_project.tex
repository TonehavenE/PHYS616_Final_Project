...
Consider an elastic circular membrane of radius $a$, perturbed from its rest state and allowed to oscillate.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{membrane_example.excalidraw.png} 
...
We thus arrive arrive at the classical wave equation:
\begin{equation}
    \boxed{\pdv[2]{u}{t} = c^2 \nabla^2 u}
...
All code can be found in the project GitHub.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{normal_modes.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{gaussian_timestrip.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{offcenter_timestrip.pdf}
    \caption{Time evolution of an off-center strike.}
    \label{fig:offcenter}
\end{figure}

The evolution continues in this dramatic fashion indefinitely. You can find an animation on the \href{}{project GitHub}.
...
We can visualize how the different modes respond by plotting the ampiltude of $C_{mn}$ as a function of $\Omega$:

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{resonances.pdf}
...
If we set $\Omega$ to a resonsant frequency, we see the corresponding mode become dominant. The time evolution from a drum initially at rest with a resonant frequency is shown in Figure \ref{fig:resonant_drum}.

\begin{figure}[H]
    \centering
    \includegraphics[max size={\textwidth}{0.7 \textheight}]{resonant_drum_timestrip.pdf}
...
This is better visualized as an animation, which can be found in the project GitHub. 
...
\begin{itemize}
	...
	\item{\textbf{Physical Experiment}: Physically set up a membrane with a speaker beneath it and test how different frequencies cause responses.}
\end{itemize}
